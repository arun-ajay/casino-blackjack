...
const Modal = props => {
  ...
  const [showBeginShuffle, setShowBeginShuffle] = useState(true);
  ...
  return (
    <div className="modalContainer">
      <div className="closeDiv">
        ...
        <div id="how-it-works" data-tip={dataTip} data-html={true}>
          How it works?
        </div>
      </div>
      <div className="box">
        {startOfShuffle ? (
          <div id="deckHeader">Shuffling Array...</div>
        ) : (
        ...
        <div id="binaryHeader">Generated rFy (Partitioned into 6 bits):</div>
        ...
        <div id="note">
          Note: the integer value of each partition will give us the index to
          shuffle our deck with.
        </div>
        {showShuffledArray ? (
          <div className="bottomWrapper">
            <div id="binaryHeader">Full Deck</div>
            {showShuffledArray ? (
            ...
            <div id="ropstenLink">
              ...
              <a href={link} target="_blank">
                https://ropsten.etherscan.io/address/{props.link}
              </a>
            </div>
          </div>
        ) : null}
